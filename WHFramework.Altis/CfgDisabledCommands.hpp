/*
    COMMANDS: ADDGROUPICON, ADDMPEVENTHANDLER, ALLVARIABLES, CALLEXTENSION, CREATEMINE, CREATETEAM, CREATEUNIT, CTRLCLASSNAME, CTRLMODEL, CTRLREMOVEALLEVENTHANDLERS, DISPLAYREMOVEALLEVENTHANDLERS, DISPLAYSETEVENTHANDLER, ENABLECOLLISIONWITH, ENABLEFATIGUE, FORCEADDUNIFORM, LOADFILE, ONEACHFRAME, ONMAPSINGLECLICK, PUBLICVARIABLE, REMOVEALLACTIONS, REMOVEALLCURATORADDONS, REMOVEALLEVENTHANDLERS, REMOVEALLITEMS, REMOVEALLMISSIONEVENTHANDLERS, REMOVEALLMPEVENTHANDLERS, REMOVEALLMUSICEVENTHANDLERS, REMOVEALLUSERACTIONEVENTHANDLERS, REMOVEMPEVENTHANDLER, SETAMMO, SETDAMMAGE, SETFRIEND, SETGROUPICONPARAMS, SETGROUPICONSSELECTABLE, SETGROUPICONSVISIBLE, SETUNITRECOILCOEFFICIENT
*/
...
class CfgDisabledCommands
{
    ...
    class DISPLAYREMOVEALLEVENTHANDLERS
    {
        class SYNTAX1
        {
            targets[] = {1,1,1}; // {0,0,0}
    ...
    class REMOVEALLCURATORADDONS
    {
        class SYNTAX1
        {
            targets[] = {1,1,1}; // breaks curator modules?
            args[] = {{},{"OBJECT"}};
        };
    };
    ...
    class REMOVEALLMUSICEVENTHANDLERS
    {
        class SYNTAX1
        {
            targets[] = {0,0,0};
    ...
    class REMOVEALLUSERACTIONEVENTHANDLERS
    {
        class SYNTAX1
        {
            targets[] = {0,0,0};

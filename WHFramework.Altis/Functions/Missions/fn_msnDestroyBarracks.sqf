...
private _infCount = [40, 80] call WHF_fnc_scaleUnitsSide;
private _infGroups = [
    opfor,
    [
...
private _threshold = _initialUnitCount * 0.2;
...
while {true} do {
    ...
    if (_current <= _threshold) exitWith {
        private _message = "$STR_WHF_destroyBarracks_success";

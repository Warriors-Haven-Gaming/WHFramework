...
private _resolvedTypes = _this apply {
    switch (_x) do {
        ...
        case ["heli_attack",  "e22_raf_alpine"]: {["E22_O_RAF_A_Heli_Light_02_dynamicLoadout_F"]};
        case ["heli_gunship", "e22_raf_alpine"]: {["E22_O_RAF_A_Heli_Attack_02_dynamicLoadout_F"]};
        case ["heli_light",   "e22_raf_alpine"]: {[]};
        case ["heli_medium",  "e22_raf_alpine"]: {["E22_O_RAF_A_Heli_Light_02_unarmed_F","E22_O_RAF_A_Heli_Transport_04_F"]};
        case ["jet_cap",      "e22_raf_alpine"]: {["E22_O_RAF_A_Plane_Fighter_02_F","E22_O_RAF_A_Plane_Fighter_02_Stealth_F"]};
        case ["jet_cas",      "e22_raf_alpine"]: {["E22_O_RAF_A_Plane_CAS_02_dynamicLoadout_F"]};
        case ["heli_attack",  "e22_raf_arid"]: {["E22_O_RAF_D_Heli_Light_02_dynamicLoadout_F"]};
        case ["heli_gunship", "e22_raf_arid"]: {["E22_O_RAF_D_Heli_Attack_02_dynamicLoadout_F"]};
        case ["heli_light",   "e22_raf_arid"]: {[]};
        case ["heli_medium",  "e22_raf_arid"]: {["E22_O_RAF_D_Heli_Light_02_unarmed_F","E22_O_RAF_D_Heli_Transport_04_F"]};
        case ["jet_cap",      "e22_raf_arid"]: {["E22_O_RAF_D_Plane_Fighter_02_F","E22_O_RAF_D_Plane_Fighter_02_Stealth_F"]};
        case ["jet_cas",      "e22_raf_arid"]: {["E22_O_RAF_D_Plane_CAS_02_dynamicLoadout_F"]};
        case ["heli_attack",  "e22_raf_woodland"]: {["E22_O_RAF_Heli_Light_02_dynamicLoadout_F"]};
        case ["heli_gunship", "e22_raf_woodland"]: {["E22_O_RAF_Heli_Attack_02_dynamicLoadout_F"]};
        case ["heli_light",   "e22_raf_woodland"]: {[]};
        case ["heli_medium",  "e22_raf_woodland"]: {["E22_O_RAF_Heli_Light_02_unarmed_F","E22_O_RAF_Heli_Transport_04_F"]};
        case ["jet_cap",      "e22_raf_woodland"]: {["E22_O_RAF_Plane_Fighter_02_F","E22_O_RAF_Plane_Fighter_02_Stealth_F"]};
        case ["jet_cas",      "e22_raf_woodland"]: {["E22_O_RAF_Plane_CAS_02_dynamicLoadout_F"]};

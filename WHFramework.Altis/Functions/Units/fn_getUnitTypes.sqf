...
private _resolvedTypes = _this apply {
    switch (_x) do {
        ...
        case ["standard", "csat"]: {["O_Soldier_A_F","O_Soldier_AAR_F","O_Soldier_AR_F","O_medic_F","O_engineer_F","O_soldier_exp_F","O_Soldier_GL_F","O_HeavyGunner_F","O_soldier_M_F","O_soldier_repair_F","O_Soldier_F","O_Soldier_LAT_F","O_Soldier_lite_F","O_Sharpshooter_F","O_Soldier_SL_F","O_Soldier_TL_F","O_soldier_UAV_F"]};
        case ["standard", "csat_pacific"]: {["O_T_Soldier_A_F","O_T_Soldier_AAR_F","O_T_Soldier_AR_F","O_T_Medic_F","O_T_Engineer_F","O_T_Soldier_Exp_F","O_T_Soldier_GL_F","O_T_Soldier_M_F","O_T_Soldier_Repair_F","O_T_Soldier_F","O_T_Soldier_LAT_F","O_T_Soldier_SL_F","O_T_Soldier_TL_F","O_T_Soldier_UAV_F"]};
        case ["standard", "aaf"]: {["I_Soldier_A_F","I_Soldier_AAR_F","I_Soldier_AR_F","I_medic_F","I_Soldier_exp_F","I_Soldier_GL_F","I_Soldier_M_F","I_soldier_mine_F","I_Soldier_repair_F","I_soldier_F","I_Soldier_LAT2_F","I_Soldier_SL_F","I_Soldier_TL_F","I_soldier_UAV_F"]};
        ...
        case ["standard", "ws_sfia"]: {["O_SFIA_Soldier_AR_lxWS","O_SFIA_medic_lxWS","O_SFIA_exp_lxWS","O_SFIA_Soldier_GL_lxWS","O_SFIA_HeavyGunner_lxWS","O_SFIA_repair_lxWS","O_SFIA_soldier_lxWS","O_SFIA_soldier_lite_lxWS","O_SFIA_sharpshooter_lxWS","O_SFIA_Soldier_TL_lxWS","O_soldier_UAV_F"]};
        ...
        case ["standard", "cup_npc"]: {["CUP_I_GUE_Ammobearer","CUP_I_GUE_Soldier_AR","CUP_I_GUE_Officer","CUP_I_GUE_Soldier_GL","CUP_I_GUE_Soldier_MG","CUP_I_GUE_Engineer","CUP_I_GUE_Medic","CUP_I_GUE_Soldier_AKS74","CUP_I_GUE_Soldier_AKM","CUP_I_GUE_Soldier_AKSU","CUP_I_GUE_Soldier_LAT","CUP_I_GUE_Soldier_AT","CUP_I_GUE_Soldier_AA2","CUP_I_GUE_Saboteur","CUP_I_GUE_Commander","O_soldier_UAV_F"]};
        case ["standard", "cup_tk"]: {["CUP_O_TK_Soldier_AAT","CUP_O_TK_Soldier_AMG","CUP_O_TK_Soldier_AR","CUP_O_TK_Engineer","CUP_O_TK_Soldier_GL","CUP_O_TK_Soldier_MG","CUP_O_TK_Soldier_M","CUP_O_TK_Medic","CUP_O_TK_Soldier","CUP_O_TK_Soldier_Backpack","CUP_O_TK_Soldier_LAT","CUP_O_TK_Soldier_AT","CUP_O_TK_Soldier_SL","O_soldier_UAV_F"]};
        case ["standard", "cup_tk_ins"]: {["CUP_O_TK_INS_Soldier_AR","CUP_O_TK_INS_Guerilla_Medic","CUP_O_TK_INS_Soldier_MG","CUP_O_TK_INS_Bomber","CUP_O_TK_INS_Mechanic","CUP_O_TK_INS_Soldier_GL","CUP_O_TK_INS_Soldier","CUP_O_TK_INS_Soldier_FNFAL","CUP_O_TK_INS_Soldier_Enfield","CUP_O_TK_INS_Soldier_AAT","CUP_O_TK_INS_Soldier_AT","CUP_O_TK_INS_Sniper","CUP_O_TK_INS_Soldier_TL","O_soldier_UAV_F"]};
        case ["standard", "gendarmerie"]: {["B_GEN_Soldier_F"]};
        case ["standard", "nato"]: {["B_Soldier_A_F","B_soldier_AR_F","B_medic_F","B_engineer_F","B_soldier_exp_F","B_Soldier_GL_F","B_HeavyGunner_F","B_soldier_M_F","B_soldier_mine_F","B_soldier_repair_F","B_Soldier_F","B_Soldier_lite_F","B_soldier_LAT2_F","B_Sharpshooter_F","B_Soldier_SL_F","B_Soldier_TL_F","B_soldier_UAV_F"]};
        case ["standard", "nato_pacific"]: {["B_T_Soldier_A_F","B_T_soldier_AR_F","B_T_medic_F","B_T_engineer_F","B_T_soldier_exp_F","B_T_Soldier_GL_F","B_T_soldier_M_F","B_T_soldier_mine_F","B_T_soldier_repair_F","B_T_Soldier_F","B_T_Soldier_LAT2_F","B_T_soldier_SL_F","B_T_soldier_TL_F","B_T_soldier_UAV_F"]};
        case ["standard", "ef_mjtf_desert"]: {["EF_B_Marine_AR_Des","EF_B_Marine_Medic_Des","EF_B_Marine_Eng_Des","EF_B_Marine_Exp_Des","EF_B_Marine_GL_Des","EF_B_Marine_JTAC_Des","EF_B_Marine_Mark_Des","EF_B_Marine_Repair_Des","EF_B_Marine_R_Des","EF_B_Marine_LAT2_Des","EF_B_Marine_SL_Des","EF_B_Marine_TL_Des","EF_B_Marine_UAV_Des"]};
        case ["standard", "ef_mjtf_woodland"]: {["EF_B_Marine_AR_Wdl","EF_B_Marine_Medic_Wdl","EF_B_Marine_Eng_Wdl","EF_B_Marine_Exp_Wdl","EF_B_Marine_GL_Wdl","EF_B_Marine_JTAC_Wdl","EF_B_Marine_Mark_Wdl","EF_B_Marine_Repair_Wdl","EF_B_Marine_R_Wdl","EF_B_Marine_LAT2_Wdl","EF_B_Marine_SL_Wdl","EF_B_Marine_TL_Wdl","EF_B_Marine_UAV_Wdl"]};
        ...
        case ["standard", "ws_una"]: {["B_UN_soldier_AR_lxWS","B_UN_medic_lxWS","B_UN_engineer_lxWS","B_UN_Soldier_GL_lxWS","B_UN_HeavyGunner_lxWS","B_UN_soldier_repair_lxWS","B_UN_Soldier_lxWS","B_UN_soldier_LAT2_lxWS","B_UN_Soldier_TL_lxWS"]};
        ...
        case ["aa", "ws_sfia"]: {["O_SFIA_Soldier_AAA_lxWS","O_SFIA_soldier_aa_lxWS"]};
        // case ["aa", "ws_tura"]: {[]};
        // case ["aa", "e22_raf_alpine"]: {[]};
        // case ["aa", "e22_raf_arid"]: {[]};
        // case ["aa", "e22_raf_woodland"]: {[]};
        case ["aa", "rhsafrf"]: {["rhs_vdv_aa"]};
        case ["aa", "cup_afrf"]: {["CUP_O_RU_Soldier_AA_VDV_EMR"]};
        case ["aa", "cup_afrf_modern"]: {["CUP_O_RUS_M_Soldier_AA_Ratnik_Summer"]};
        case ["aa", "cup_npc"]: {["CUP_I_GUE_Soldier_AA"]};
        case ["aa", "cup_tk"]: {["CUP_O_TK_Soldier_AA"]};
        case ["aa", "cup_tk_ins"]: {["CUP_O_TK_INS_Soldier_AA"]};
        // case ["aa", "gendarmerie"]: {[]};
        case ["aa", "nato"]: {["B_soldier_AAA_F","B_soldier_AA_F"]};
        case ["aa", "nato_pacific"]: {["B_T_Soldier_AAA_F","B_T_Soldier_AA_F"]};
        case ["aa", "ef_mjtf_desert"]: {["EF_B_Marine_AAA_Des","EF_B_Marine_AA_Des"]};
        case ["aa", "ef_mjtf_woodland"]: {["EF_B_Marine_AAA_Wdl","EF_B_Marine_AA_Wdl"]};
        // case ["aa", "ws_ion"]: {[]};
        // case ["aa", "ws_una"]: {[]};
        ...
        case ["at", "ws_sfia"]: {["O_SFIA_Soldier_AAT_lxWS","O_SFIA_soldier_at_lxWS"]};
        // case ["at", "ws_tura"]: {[]};
        case ["at", "e22_raf_alpine"]: {["E22_O_RAF_A_Soldier_LAT_F"]};
        case ["at", "e22_raf_arid"]: {["E22_O_RAF_D_Soldier_LAT_F"]};
        case ["at", "e22_raf_woodland"]: {["E22_O_RAF_Soldier_LAT_F"]};
        case ["at", "rhsafrf"]: {["rhs_vdv_LAT","rhs_vdv_at"]};
        case ["at", "cup_afrf"]: {["CUP_O_RU_Soldier_HAT_VDV_EMR","CUP_O_RU_Soldier_AT_VDV_EMR"]};
        case ["at", "cup_afrf_modern"]: {["CUP_O_RUS_M_Soldier_AHAT_Ratnik_Summer","CUP_O_RUS_M_Soldier_HAT_Ratnik_Summer"]};
        case ["at", "cup_npc"]: {["CUP_O_TK_Soldier_LAT","CUP_O_TK_Soldier_AT"]};
        case ["at", "cup_tk"]: {["CUP_O_TK_Soldier_HAT"]};
        case ["at", "cup_tk_ins"]: {["CUP_O_TK_INS_Soldier_AT"]};
        // case ["at", "gendarmerie"]: {[]};
        case ["at", "nato"]: {["B_soldier_AAT_F","B_soldier_AT_F","B_soldier_LAT_F"]};
        case ["at", "nato_pacific"]: {["B_T_Soldier_AAT_F","B_T_Soldier_AT_F","B_T_Soldier_LAT_F"]};
        case ["at", "ef_mjtf_desert"]: {["EF_B_Marine_AAT_Des","EF_B_Marine_AT_Des","EF_B_Marine_LAT_Des"]};
        case ["at", "ef_mjtf_woodland"]: {["EF_B_Marine_AAT_Wdl","EF_B_Marine_AT_Wdl","EF_B_Marine_LAT_Wdl"]};
        case ["at", "ws_ion"]: {["B_ION_soldier_LAT2_lxWS"]};
        case ["at", "ws_una"]: {["B_UN_soldier_LAT2_lxWS"]};
        case ["at", "cup_usa_woodland"]: {["CUP_B_US_Soldier_AHAT_OEFCP","CUP_B_US_Soldier_HAT_OEFCP"]};
        case ["at", "cup_usmc_woodland"]: {["CUP_B_USMC_Soldier_HAT"]};
        ...
        case ["officer", "e22_raf_alpine"]: {["E22_O_RAF_A_Officer_Field_F","E22_O_RAF_A_Officer_F"]};
        case ["officer", "e22_raf_arid"]: {["E22_O_RAF_D_Officer_Field_F","E22_O_RAF_D_Officer_F"]};
        case ["officer", "e22_raf_woodland"]: {["E22_O_RAF_Officer_Field_F","E22_O_RAF_Officer_F"]};
        ...
        case ["officer", "gendarmerie"]: {["B_GEN_Commander_F"]};
        ...
        case ["officer", "ws_una"]: {["B_UN_officer_lxWS"]};
        ...
        case ["crew", "e22_raf_alpine"]: {["E22_O_RAF_A_Crewman_F"]};
        case ["crew", "e22_raf_arid"]: {["E22_O_RAF_D_Crewman_F"]};
        case ["crew", "e22_raf_woodland"]: {["E22_O_RAF_Crewman_F"]};
        ...
        case ["crew", "gendarmerie"]: {["B_GEN_Soldier_F"]};
        ...
        case ["crew", "ws_una"]: {["B_UN_crew_lxWS"]};
        ...
        case ["diver", "e22_raf_alpine"]: {["O_diver_F","O_diver_exp_F","O_diver_TL_F"]};
        case ["diver", "e22_raf_arid"]: {["O_diver_F","O_diver_exp_F","O_diver_TL_F"]};
        case ["diver", "e22_raf_woodland"]: {["O_diver_F","O_diver_exp_F","O_diver_TL_F"]};
        ...
        case ["diver", "gendarmerie"]: {["O_diver_F","O_diver_exp_F","O_diver_TL_F"]};
        ...
        case ["diver", "ws_una"]: {["O_diver_F","O_diver_exp_F","O_diver_TL_F"]};
        ...
        case ["recon", "e22_raf_alpine"]: {["E22_O_RAF_A_Recon_TL_F","E22_O_RAF_A_Recon_LAT_F","E22_O_RAF_A_Recon_F","E22_O_RAF_A_Recon_CLS_F","E22_O_RAF_A_Recon_M_F","E22_O_RAF_A_Recon_JTAC_F","E22_O_RAF_A_Recon_EXP_F"]};
        case ["recon", "e22_raf_arid"]: {["E22_O_RAF_D_Recon_TL_F","E22_O_RAF_D_Recon_LAT_F","E22_O_RAF_D_Recon_F","E22_O_RAF_D_Recon_CLS_F","E22_O_RAF_D_Recon_M_F","E22_O_RAF_D_Recon_JTAC_F","E22_O_RAF_D_Recon_EXP_F"]};
        case ["recon", "e22_raf_woodland"]: {["E22_O_RAF_Recon_TL_F","E22_O_RAF_Recon_LAT_F","E22_O_RAF_Recon_F","E22_O_RAF_Recon_CLS_F","E22_O_RAF_Recon_M_F","E22_O_RAF_Recon_JTAC_F","E22_O_RAF_Recon_EXP_F"]};
        ...
        case ["recon", "gendarmerie"]: {["B_GEN_Soldier_F"]};
        ...
        case ["recon", "ws_una"]: {["B_UN_Soldier_lite_lxWS"]};
        ...
        case ["elite", "e22_raf_alpine"]: {["E22_O_RAF_A_Special_EXP_F","E22_O_RAF_A_Special_JTAC_F","E22_O_RAF_A_Special_M_F","E22_O_RAF_A_Special_TL_F","E22_O_RAF_A_Special_LAT_F","E22_O_RAF_A_Special_F","E22_O_RAF_A_Special_CLS_F"]};
        case ["elite", "e22_raf_arid"]: {["E22_O_RAF_D_Special_EXP_F","E22_O_RAF_D_Special_JTAC_F","E22_O_RAF_D_Special_M_F","E22_O_RAF_D_Special_TL_F","E22_O_RAF_D_Special_LAT_F","E22_O_RAF_D_Special_F","E22_O_RAF_D_Special_CLS_F"]};
        case ["elite", "e22_raf_woodland"]: {["E22_O_RAF_Special_EXP_F","E22_O_RAF_Special_JTAC_F","E22_O_RAF_Special_M_F","E22_O_RAF_Special_TL_F","E22_O_RAF_Special_LAT_F","E22_O_RAF_Special_F","E22_O_RAF_Special_CLS_F"]};
        ...
        case ["elite", "gendarmerie"]: {["B_GEN_Soldier_F"]};
        ...
        case ["elite", "ws_una"]: {["B_D_recon_exp_lxWS","B_D_recon_JTAC_lxWS","B_D_recon_M_lxWS","B_D_recon_medic_lxWS","B_D_recon_lxWS","B_D_recon_LAT_lxWS","B_D_recon_TL_lxWS"]};
        ...
        case ["sniper", "e22_raf_alpine"]: {["E22_O_RAF_A_Special_Sharpshooter_F","E22_O_RAF_A_Recon_Sharpshooter_F","E22_O_RAF_A_Sharpshooter_F"]};
        case ["sniper", "e22_raf_arid"]: {["E22_O_RAF_D_Special_Sharpshooter_F","E22_O_RAF_D_Recon_Sharpshooter_F","E22_O_RAF_D_Sharpshooter_F"]};
        case ["sniper", "e22_raf_woodland"]: {["E22_O_RAF_Special_Sharpshooter_F","E22_O_RAF_Recon_Sharpshooter_F","E22_O_RAF_Sharpshooter_F"]};
        ...
        case ["sniper", "gendarmerie"]: {["B_sniper_F"]};
        ...
        case ["sniper", "ws_una"]: {["B_sniper_F","B_ghillie_ard_F","B_ghillie_lsh_F","B_ghillie_sard_F"]};
        ...
        case ["pilot_heli", "e22_raf_alpine"]: {["E22_O_RAF_A_Helipilot_F","E22_O_RAF_A_Helicrew_F"]};
        case ["pilot_heli", "e22_raf_arid"]: {["E22_O_RAF_D_Helipilot_F","E22_O_RAF_D_Helicrew_F"]};
        case ["pilot_heli", "e22_raf_woodland"]: {["E22_O_RAF_Helipilot_F","E22_O_RAF_Helicrew_F"]};
        ...
        case ["pilot_heli", "gendarmerie"]: {["B_GEN_Soldier_F"]};
        ...
        case ["pilot_heli", "ws_una"]: {["B_UN_Helipilot_lxWS"]};
        ...
        case ["pilot_jet", "e22_raf_alpine"]: {["E22_O_RAF_A_Fighter_Pilot_F"]};
        case ["pilot_jet", "e22_raf_arid"]: {["E22_O_RAF_D_Fighter_Pilot_F"]};
        case ["pilot_jet", "e22_raf_woodland"]: {["E22_O_RAF_Fighter_Pilot_F"]};
        ...
        case ["pilot_jet", "gendarmerie"]: {["B_Pilot_F"]};
        ...
        case ["pilot_jet", "ws_una"]: {["B_Pilot_F"]};

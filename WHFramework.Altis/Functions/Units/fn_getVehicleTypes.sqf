...
private _resolvedTypes = _this apply {
    switch (_x) do {
        ...
        case ["apc",      "e22_raf_alpine"]: {["E22_O_RAF_A_APC_Wheeled_02_rcws_F"]};
        ...
        case ["apc",      "e22_raf_arid"]: {["E22_O_RAF_D_APC_Wheeled_02_rcws_F"]};
        ...
        case ["apc",      "e22_raf_woodland"]: {["E22_O_RAF_APC_Wheeled_02_rcws_F"]};

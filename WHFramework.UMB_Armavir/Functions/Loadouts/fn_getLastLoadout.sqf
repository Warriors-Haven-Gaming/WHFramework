...
private _loadout = _loadouts getOrDefaultCall [_key, {switch (_role) do {
    ...
    case "pilot_cas_heli": {[["SMG_01_F","","","optic_Holosight_smg",["30Rnd_45ACP_Mag_SMG_01",30],[],""],[],[],["U_B_HeliPilotCoveralls",[["FirstAidKit",5]]],["V_TacVest_blk",[["FirstAidKit",5],["30Rnd_45ACP_Mag_SMG_01",4,30],["SmokeShellGreen",1,1],["SmokeShellBlue",1,1],["SmokeShellOrange",1,1],["SmokeShell",1,1],["Chemlight_green",2,1]]],[],"H_PilotHelmetHeli_B","",["Binocular","","","",[],[],""],["ItemMap","ItemGPS","ItemRadio","ItemCompass","ItemWatch","NVGoggles"]]};
    case "pilot_cas_plane": {[[],[],["hgun_P07_F","","","",["16Rnd_9x21_Mag",16],[],""],["U_B_PilotCoveralls",[["FirstAidKit",4],["16Rnd_9x21_Mag",3,16],["SmokeShellOrange",1,1],["Chemlight_green",2,1]]],[],[],"H_PilotHelmetFighter_B","",["Binocular","","","",[],[],""],["ItemMap","ItemGPS","ItemRadio","ItemCompass","ItemWatch",""]]};

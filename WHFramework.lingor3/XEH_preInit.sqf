...
private _opfor = [
    ...
    "WHF_factions_e22_raf_alpine",
    "WHF_factions_e22_raf_arid",
    "WHF_factions_e22_raf_woodland",
...
[
    "WHF_loadout_save_on_arsenal",
    "CHECKBOX",
    ["STR_WHF_settings_loadout_save_on_arsenal", "STR_WHF_settings_loadout_save_on_arsenal_tooltip"],
    ["STR_WHF_settings", "STR_WHF_settings_loadouts"],
    true,
    false,
    {},
...
[
    ...
    ["STR_WHF_settings_missions", "STR_WHF_settings_missions_annex"],
    '[["standard", 2, 8, 0], 0.6, ["aa", 2, 4, 0], 0.1, ["at", 2, 4, 0], 0.1, ["recon", 2, 8, 1], 0.1, ["elite", 4, 8, 2], 0.05, ["sniper", 2, 2, 3], 0.05]',
    true,

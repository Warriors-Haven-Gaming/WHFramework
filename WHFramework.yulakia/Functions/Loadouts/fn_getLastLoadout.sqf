...
_loadouts getOrDefaultCall [_key, {switch (_role) do {
    case "arty": {[["CUP_arifle_M4A1","","","",["30Rnd_556x45_Stanag_Tracer_Red",30],[],""],[],["CUP_hgun_Colt1911","","","",["CUP_7Rnd_45ACP_1911",7],[],""],["CUP_U_B_USMC_MCCUU_gloves",[["FirstAidKit",5]]],["CUP_V_B_Eagle_SPC_Crew",[["FirstAidKit",1],["CUP_7Rnd_45ACP_1911",2,7],["SmokeShell",3,1],["30Rnd_556x45_Stanag_Tracer_Red",11,30]]],[],"CUP_H_CVC","CUP_G_Shades_Blue",[],["ItemMap","ItemGPS","ItemRadio","ItemCompass","ItemWatch","CUP_NVG_PVS7_Hide"]]};
    // FIXME: remake AA loadout for CUP
